              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="text-left border-b">
                    <th className="py-2 pr-3 w-[30%]">Group</th>
                ...
                <tbody>
                  {items.map((g) => (
                    <tr key={g.id} className="border-b align-top">
                      ...
                      <td className="py-2 pr-3 whitespace-nowrap"><Badge variant="blue">{g.total ?? 0}</Badge></td>
                      ...
                      <td className="py-2 pr-2">
                        <div className="flex flex-wrap gap-2">
                          <Link href={`/packages/${pkgId}/groups/${g.id}`} className="inline-flex">
